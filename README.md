...
```
cordova plugin add https://github.com/NguyenTaiAnh/cordova-plugin-ibeacon.git
```
...
See the [LocationManager](https://github.com/NguyenTaiAnh/cordova-plugin-ibeacon/blob/master/www/LocationManager.js)'s 
